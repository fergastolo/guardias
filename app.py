...
def diagnosticar_conflictos():
    ...
    def obtener_disponibles(dia_idx, df_staff, is_adj, exclude_nom):
        ...
        for _, r in df_staff.iterrows():
            ...
            # 4. Regla Viernes -> Domingo (Solo residentes)
            if not is_adj:
                if wd == 4 and dia_idx+2 < n_dias: # Es viernes
                ...
                if wd == 6 and dia_idx-2 >= 0: # Es domingo
